    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          githubUrl: "https://github.com/mitchoder07/cyber-words-guess",
          liveUrl: "https://word-guessing-game-nine.vercel.app/",
        },
        {
          name: "Kopi",
          tagline: "Coffee shop experience with warm, inviting design",
          description:
            "A coffee shop web experience designed to feel warm and inviting. Features a menu showcase, product cards with hover animations, and a smooth checkout flow. Designed the brand identity, color palette, and component library around a cozy coffee aesthetic.",
          role: "Frontend Engineer & UI/UX Designer",
          impact: "Brand identity, animated product cards, smooth checkout flow",
          tech: ["HTML5", "CSS3", "JavaScript"],
          image: "/portfolio-images/kopi.png",
          githubUrl: "https://github.com/mitchoder07/kopi",
