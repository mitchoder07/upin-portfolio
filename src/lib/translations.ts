    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "This is a placeholder slot for a future design case study. Swap it with your next Figma project.",
          role: "Your Role Here",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          tagline: "Slot menunggu kajian kes Figma seterusnya",
          description:
            "Ini adalah slot ruang letak untuk kajian kes reka bentuk akan datang. Tukar dengan projek Figma seterusnya anda.",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          tagline: "Wuri mai jiran nazari kan harka ta gaba ta Figma",
          description:
            "Wannan wuri ne mai jiran nazari kan harkar tsara za ta zo. Sauƙaƙe shi da aikin Figma na gaba.",
  ...
  yo: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          name: "[Ìdà Rẹ Tó Ń Bọ̀]",
          tagline: "Ibi tí ó ń retí ìwádìí iṣẹ́ Figma tó ń bọ̀",
          description:
            "Èyí jẹ́ ibi-àfikún fún ìwádìí ìdà tó ń bọ̀. Pàá pàá yìí, a lè yí ọ̀pọ̀lọpọ̀ pẹ̀lú iṣẹ́ Figma tó ń bọ̀.",
          role: "Ipò Rẹ Níbí",
  ...
  ja: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          name: "[あなたの次のデザイン]",
          tagline: "次のFigmaケーススタディを待つスロット",
          description:
            "これは将来のデザインケーススタディ用のプレースホルダースロットです。次のFigmaプロジェクトに差し替えてください。",
          role: "あなたの役割",
          impact: "あなたのインパクト指標",
          tech: ["Figma", "Next.js", "Tailwind CSS"],
        },
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "هذه فتحة مؤقتة لدراسة حالة تصميم مستقبلية. استبدلها بمشروع Figma القادم.",
          role: "دورك هنا",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "这是为未来设计案例研究预留的占位位置。用你下一个 Figma 项目替换它。",
          role: "你的角色",
          impact: "你的影响指标",
          tech: ["Figma", "Next.js", "Tailwind CSS"],
        },
